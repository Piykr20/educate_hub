            ...
            <Card className="shadow-sm border-0">
              <Card.Body className="p-4">
                ...
                <Alert variant="info" className="mb-4">
                  ...
                  <div className="small">
                    <p className="mb-1"><strong>Student:</strong> student@example.com</p>
                    <p className="mb-1"><strong>Instructor:</strong> instructor@example.com</p>
                    <p className="mb-1"><strong>Admin:</strong> admin@example.com</p>
                ...
                <div className="text-center">
                  ...
                  <Row>
                    <Col>
                      <Button variant="outline-secondary" className="w-100 mb-2 btn-social">
